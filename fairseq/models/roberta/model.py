...
class RobertaModel(FairseqEncoderModel):
    ...
    @staticmethod
    def add_args(parser):
        parser.add_argument("--link", type=bool)
...
class RobertaEncoder(FairseqEncoder):
    ...
    def forward(
        ...
        **unused,
        ...
        return x, (extra['attn_tensor'], None, None, None, None, None)
    ...
    def extract_features(self, src_tokens, return_all_hiddens=False, **kwargs):
        ...
        attn_tensor = encoder_out["attn_tensor"]
        return features, {"attn_tensor": attn_tensor, "inner_states": inner_states}
...
@register_model_architecture("roberta", "roberta_link")
def roberta_link(args):
    args.link = True

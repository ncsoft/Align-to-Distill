...
def main(cfg: FairseqConfig) -> None:
    ...
    if ((cfg.task._name == "kd_translation") and (cfg.criterion._name == "kd_label_smoothed_cross_entropy")) or \
    ((cfg.task._name == "kd_sentence_prediction") and (cfg.criterion._name == "kd_sentence_prediction")):
